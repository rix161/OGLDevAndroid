...
public class myRenderer16 implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl10, EGLConfig eglConfig) {
        ...
        mFShaderId = ShaderHelper.generateShader(GLES20.GL_FRAGMENT_SHADER, FileReader.readTextFileFromRawResource(mContext,R.raw.tutorial16fs));
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        mShape.draw(mVertexDataHandle,mColorDataHandle,mTextureSamplerHandle,mTextureCoordHandle);
    }
