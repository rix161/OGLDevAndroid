 ...
 */
public class myRenderer10 implements GLSurfaceView.Renderer {
    ...
    static float mScale = 1f;
    Boolean doIncrement = true;

    public myRenderer10(Context applicationContext) {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        Matrix.rotateM(mMatrix,0,mScale,0.0f,1.0f,0.0f);
